...
class WindowForConvertSettings(customtkinter.CTkToplevel):
    def __init__(self, engine_instance):
        ...
        self.geometry("270x210+1155+400")
    ...
    def create_widgets(self):
        ...
        switch_quality = customtkinter.CTkSwitch(self, text="Reduce image quality",
                                                 command=event_quality, variable=switch_var_quality,
        ...
        switch_shadow = customtkinter.CTkSwitch(self, text="Remove shadow",
                                                command=remove_shadow_command, variable=switch_var_shadow,
                                                onvalue="on", offvalue="off",
                                                font=("Arial", 18))
        ...
        switch_combine = customtkinter.CTkSwitch(self, text="Combine into one file.",
                                                 command=event_combine, variable=switch_var,
                                                 onvalue="on", offvalue="off",
                                                 font=("Arial", 18))
...
class WindowForSplitSettings(customtkinter.CTkToplevel):
    def __init__(self, engine_instance):
        super().__init__()
        self.title("Additional_settings")
        self.geometry("260x150+1155+400")
        self.resizable(False, False)
        self.engine = engine_instance
        self.check_var = customtkinter.IntVar(value=1)
        self.create_widgets()
    ...
    def create_widgets(self):
        ...
        self.button_upload.place(x=90, y=110)
